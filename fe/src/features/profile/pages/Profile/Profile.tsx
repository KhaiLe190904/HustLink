          ...
          {editingExperience ? (
            <div className="mb-4 grid gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4">
              ...
              <div className="grid gap-3 md:grid-cols-4">
                ...
                <select
                  value={
                    experienceDraft.isPresent ? "present" : (experienceDraft.endYear ?? "")
                  }
                  onChange={(event) => {
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      setExperienceDraft((prev) => ({
                        ...
                        endYear: event.target.checked ? undefined : prev.endYear,
                        endMonth:
                          event.target.checked ? undefined : prev.endMonth,
                      }))
                    }
                  />
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  if (!experienceDraft.isPresent && start && end && end < start) {
                    setExperienceDateError(
          ...
          {editingEducation ? (
            <div className="mb-4 grid gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4">
              ...
              <button
                className="justify-self-start rounded-full bg-[var(--primary-color)] px-4 py-2 text-sm font-semibold text-white"
                onClick={async () => {
                  if (!educationDraft.degree.trim() || !educationDraft.school.trim()) {
                    setEducationFormError(
